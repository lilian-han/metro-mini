  ...
  util = {
    ...
    ignoreByRule: function (t, e) {
      ...
      if (((this.isString(e) || e.source || 'Function' === this.T(e)) && (e = [e]), !this.isArray(e)))
        return (
          util.warn('[cloudMonitor] invalid rules of ignore config, (list of) String/RegExp/Funcitons are available'),
          !1
        );
      for (var n, r = [], o = 0, i = e.length; o < i; o++)
        if (((n = e[o]), this.isString(n))) r.push(n.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, '\\$1'));
        else if (n && n.source) r.push(n.source);
        else if (n && 'Function' === this.T(n) && !0 === this.safetyCall(n, [t], !1)) return !0;
      let a = new RegExp(r.join('|'), 'i');
      return !!(r.length && a.test && a.test(t));
    },
    T: function (t, e) {
      let n = Object.prototype.toString.call(t).substring(8).replace(']', '');
      return e ? n === e : n;
    },
    J: function (t) {
  ...
  pushToQueue = function (e, t) {
    let i;
    {
      if ('error' !== t.t || !(i = e.requestQueue[0]) || 'error' !== i.t || t.msg !== i.msg) {
        if ('behavior' === t.t) {
          let n = e.requestQueue && e.requestQueue.length;
...
(Base.dftCon = {
  ...
  (Base.prototype = {
    ...
    setConfig: function (e) {
      e &&
        'object' == typeof e &&
        (util.verifyConfig(e), (e = this.setImgUrl(e)), (this._conf = util.ext({}, this._conf, e)));
    },
    ...
    _lg: function (e, t, i) {
      ...
      return util.ignoreByRule(r, u) || util.ignoreByRule(util.decode(r), u)
        ? this
        : 'error' === e && (util.ignoreByRule(t.msg, o) || util.ignoreByRule(util.decode(t.msg), o))
        ? this
        : 'api' === e && (util.ignoreByRule(t.api, a) || util.ignoreByRule(util.decode(t.api), a))
        ? this
...
(Reporter.prototype = util_1.createObject(base.prototype)),
  ...
  util_1.ext(Reporter.prototype, {
    ...
    api: function (e, t, r, i, a, s) {
      ...
      let c = (this.getConfig('ignore') || {}).ignoreApis;
...
(MiniProgramLogger.prototype = util.createObject(Reporter.prototype)),
  ...
  util.ext(MiniProgramLogger.prototype, {
    ...
    getPage: function (delta) {
      let e = this._conf.getCurrentPage;
    ...
    sendHealthOnPageShowOrHide: function () {
      try {
        (this.sessionPage = this.getPage()),
          this.sendHealth(),
          this.speedCache &&
            (this._lg('speed', this.speedCache), (this.speedCache = null), clearTimeout(this.speedTimmer)),
          this.clear();
      } catch (o) {
    ...
    sendHealth: function () {
      if (this.sessionPage) {
        let e = util.ext({}, this._health);
        (e.healthy = e.errcount > 0 ? 0 : 1), (e.begin = Date.now());
        let o = e.begin - this.sBegin;
...
let miniProgramLogger = MiniProgramLogger,
      ...
      !e.isHookInstantiated &&
                  ...
                  if (i && i.url) {
                    ...
                    let p = {
                      ...
                      fail: function (t) {
                        ...
                        t && t.body && (u = (u = JSON.stringify(t.body)).substring(0, 256)),
                          e.api(
                            util.ext(
                              {
                                api: o,
        ...
        */
            if ('function' == typeof my.navigateTo) {
              ...
              a &&
                ...
                (my.navigateTo = function (i) {
                  if (i && i.url) {
                    let o = t.cutUrlSearch(t.patchPath(i.url));
                    e._lgPV({
                      page: o,
                      c3: 'nt',
                    });
            ...
            if ('function' == typeof my.navigateToMiniProgram) {
              let m = my.navigateToMiniProgram;
