...
QR8bitByte.prototype = {
  getLength: function (buffer: string) {
...
function QRCode(typeNumber: number, errorCorrectLevel: QRErrorCorrectLevelType) {
  // @ts-ignore
...
QRCode.prototype = {
  ...
  createMovieClip: function (target_mc: any, instance_name: any, depth: any) {
  ...
  setupTypeInfo: function (test: number, maskPattern: number) {
  ...
  mapData: function (data: any[], maskPattern: any) {
    let inc = -1;
...
QRCode.createData = function (typeNumber: number, errorCorrectLevel: any, dataList: any[]) {
...
QRCode.createBytes = function (buffer: any, rsBlocks: any): any[] {
  let offset = 0;
...
let QRErrorCorrectLevel: QRErrorCorrectLevelType = {
  L: 1,
  M: 0,
  Q: 3,
  H: 2,
...
let QRMaskPattern: Record<string, MaskPatternType> = {
  PATTERN000: 0,
  PATTERN001: 1,
  PATTERN010: 2,
  PATTERN011: 3,
...
var QRUtil = {
  ...
  getMask: function (maskPattern: MaskPatternType, i: number, j: number) {
    switch (maskPattern) {
...
QRRSBlock.getRSBlocks = function (typeNumber: number, errorCorrectLevel: ErrorLevelValue) {
...
QRRSBlock.getRsBlockTable = function (typeNumber: number, errorCorrectLevel: ErrorLevelValue) {
